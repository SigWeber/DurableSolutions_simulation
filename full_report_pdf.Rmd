...
(plot_density(DS_Original_colombia_ind, "Pass/fail measure") + 
    plot_density( DS_Option1_colombia_ind,"1: Full composite"))/
  (plot_density( DS_Option2_colombia_ind,"2: Composite at criterion level") + 
     plot_density( DS_Option3_colombia_ind, "3: Composite at sub-criterion level"))/  
  (plot_density( DS_Option4_colombia_ind, "4: Comparison of homogeneous cells") + 
     plot_density( DS_Option5_colombia_ind, "5: Classifier/regression-based"))
```

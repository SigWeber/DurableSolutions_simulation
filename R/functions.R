...
#' @name use_IRIS_metric
#' @rdname use_IRIS_metric
#' @title use IRIS metric
#' @description  Original framework function
#' @param \dots List of packages
#' @export use_IRIS_metric
...
#' @name use_composite
#' @rdname use_composite
#' @title use_composite
#' @description  Full composite
#' @param \dots List of packages
#' @export use_composite
...
#' @name use_criterion
#' @rdname use_criterion
#' @title use_criterion
#' @description  Composite measure at criterion level
#' @param \dots List of packages
#' @export use_criterion
...
#' @name use_subcriterion
#' @rdname use_subcriterion
#' @title use_subcriterion
#' @description  Composite measure at subcriterion level
#' @param \dots List of packages
#' @export use_subcriterion
...
#' @rdname use_cells
#' @title use_cells
#' @description  Use population cells
#' @param \dots List of packages
#' @export use_cells
...
#' @name use_classifier
#' @rdname use_classifier
#' @title use_classifier
#' @description  Use a classifier
#' @param \dots List of packages
#' @export use_classifier
